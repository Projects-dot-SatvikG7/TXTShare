...
`;const S={apiKey:"AIzaSyDg0ZCjvAPZ4KhQik6S2ubKhkF5TnkHK30",authDomain:"txt-share.firebaseapp.com",databaseURL:"https://txt-share-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"txt-share",storageBucket:"txt-share.appspot.com",messagingSenderId:"802040092553",appId:"1:802040092553:web:47c61f164c8dc5fc39b358",measurementId:"G-9X5YRQBBYD"},d=u(S);h(d);const k=new f,p=b(d),s=m(d),A=async t=>{const i=l(p,"texts",t.uid);c(i,{id:t.uid},{merge:!0});const n=await x(i),o='By using the app you accept the <a style="background: black;" href="/privacypolicy.html">Privacy Policy</a>.';n.data().data?$("#data").html(n.data().data).show():(c(i,{data:o},{merge:!0}),$("#data").html(o).show())},I=async()=>{const t=$("#newData").val();$("#newData").val(""),w(l(p,"texts",s.currentUser.uid),{data:t},{merge:!0}),$("#data").html(t).show()};$(function(){$("#sob","#profile_pic","#ud").hide(),$("#sib").show(),$("#data").html("Fetching..."),g(s,t=>{t?(A(t),$("#si").removeAttr("hidden"),$("#so").attr("hidden",!0),$("#ud").html(`
                    <h3>Hello ${t.displayName}!</h3>
                    <p>User ID: ${t.uid}</p>
                    <p>User Email: ${t.email}</p>
                    `),$("#profile_pic").attr("src",t.photoURL),$("#profile_pic").show(),$("#sib").hide(),$("#sob").show(),$("#ud").show()):($("#so").removeAttr("hidden"),$("#si").attr("hidden",!0),$("#sob").hide(),$("#sib").show(),$("#profile_pic").hide(),$("#sob","#profile_pic","#data","#ud").hide()),$("#loader").hide()}),$("#sib").click(function(){v(s,k)}),$("#sob").click(function(){y(s)}),$("#addData").click(function(){if(!$("#newData").val()){window.alert("Data cannot be empty");return}I()})});
